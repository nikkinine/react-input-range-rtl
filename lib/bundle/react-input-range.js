...
var InputRange = (_class = function (_React$Component) {
  ...
  _createClass(InputRange, null, [{
    ...
    get: function get() {
      return {
        ...
        direction: _propTypes2.default.oneOf(['ltr', 'rtl']).isRequired,
  ...
  _createClass(InputRange, [{
    ...
    value: function handleSliderDrag(event, key) {
      ...
      var position = valueTransformer.getPositionFromEvent(event, this.getTrackClientRect(), this.isRTL());
    ...
    value: function renderSliders() {
      ...
      var values = valueTransformer.getValueFromProps(this.props, this.isMultiValue());
      var percentages = valueTransformer.getPercentagesFromValues(values, this.props.minValue, this.props.maxValue, this.isRTL());
...
var Track = (_class = function (_React$Component) {
  ...
  _createClass(Track, null, [{
    ...
    get: function get() {
      return {
        ...
        classNames: _propTypes2.default.objectOf(_propTypes2.default.string).isRequired,
        draggableTrack: _propTypes2.default.bool,
        isRTL: _propTypes2.default.bool.isRequired,
  ...
  _createClass(Track, [{
    ...
    value: function getActiveTrackStyle() {
      ...
      var left = this.props.percentages.min * (this.props.isRTL ? -100 : 100) + '%';
...
function getPercentagesFromValues(values, minValue, maxValue) {
  ...
  var min = getPercentageFromValue(values.min, minValue, maxValue);
  var max = getPercentageFromValue(values.max, minValue, maxValue);
 ...
 * @return {Point}
 */
function getPositionFromEvent(event, clientRect, isRTL) {
  var length = clientRect.width;

  var _ref = event.touches ? event.touches[0] : event,
      clientX = _ref.clientX;

  var x = (0, _utils.clamp)(clientX - clientRect.left, 0, length);
  var y = 0;
